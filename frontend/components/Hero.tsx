...
const wordVariants = {
    hidden: { opacity: 0, y: 60, rotateX: -35, filter: "blur(8px)" },
    visible: (i: number) => ({
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(125deg, #0b0f35 0%, #141d6b 28%, #2030b0 54%, #3b52e0 74%, #5c70e8 90%, #8b9cf7 100%)",
                }}
            />

            {/* ── LEFT radial glow behind photo ── */}
            <div
                className="absolute inset-0 z-0 pointer-events-none"
                style={{
                    background: "radial-gradient(ellipse 55% 70% at 23% 55%, rgba(130,160,255,0.22) 0%, transparent 70%)",
                }}
            />

            {/* ── RIGHT radial glow behind text ── */}
            <div
                className="absolute inset-0 z-0 pointer-events-none"
                style={{
                    background: "radial-gradient(ellipse 55% 60% at 78% 45%, rgba(167,139,250,0.14) 0%, transparent 70%)",
                }}
            />
            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        inset: "10%",
                        borderRadius: "40% 60% 55% 45% / 45% 50% 60% 40%",
                ...
                <motion.div
                    ...
                    style={{
                        inset: "8%",
                        borderRadius: "38% 62% 52% 48% / 48% 52% 58% 42%",
                ...
                >
                    ...
                    {/* Bottom gradient overlay so text/badges read well */}
                    <div
                        className="absolute inset-0"
                        style={{
                            background: "linear-gradient(to top, rgba(11,15,53,0.82) 0%, rgba(11,15,53,0.30) 38%, transparent 65%)",
                        }}
                    />
                    {/* Left edge blend into page */}
                    <div
                        className="absolute inset-0"
                        style={{
                            background: "linear-gradient(to right, rgba(11,15,53,0.45) 0%, transparent 40%)",
                        }}
                    />
                ...
                {/* ── Floating stat CARD — top right of photo ── */}
                <motion.div
                                    ...
                                    {i === 1 && (
                                        <motion.span
                                            ...
                                            style={{
                                                ...
                                                background: "linear-gradient(90deg, rgba(196,206,255,0.7), rgba(196,206,255,0))",
                                            }}
                                        />
                                    )}
                                </motion.span>
